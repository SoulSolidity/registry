...
const ichiAddressConfig: Partial<Record<IchiSupportedChainId, Partial<Record<IchiSupportedDex, {
    ...
    [IchiSupportedChainId.arthera]: {
        [IchiSupportedDex.Thirdfy]: {
    ...
    [IchiSupportedChainId.arthera_testnet]: {
        [IchiSupportedDex.Thirdfy]: {
    ...
    [IchiSupportedChainId.base]: {
        ...
        [IchiSupportedDex.Equalizer2Thick]: {
    ...
    //     },
    // },
    [IchiSupportedChainId.blast]: {
        [IchiSupportedDex.Fenix]: {
    ...
    [IchiSupportedChainId.blast_sepolia_testnet]: {
        [IchiSupportedDex.Fenix]: {
    ...
    [IchiSupportedChainId.celo]: {
        [IchiSupportedDex.Ubeswap]: {
    ...
    [IchiSupportedChainId.eon]: {
        [IchiSupportedDex.Ascent]: {
    ...
    [IchiSupportedChainId.evmos]: {
        [IchiSupportedDex.Forge]: {
    ...
    //     },
    // },
    [IchiSupportedChainId.kava]: {
        [IchiSupportedDex.Kinetix]: {
            factoryAddress: '0x2d2c72C4dC71AA32D64e5142e336741131A73fc0',
            depositGuard: {
                address: '0xADDA3A15EA71c223a82Af86d4578EF2B076035F1',
                version: 2,
    ...
    [IchiSupportedChainId.linea]: {
        [IchiSupportedDex.Linehub]: {
    ...
    //     },
    // },
    [IchiSupportedChainId.mantle]: {
        [IchiSupportedDex.Agni]: {
    ...
    [IchiSupportedChainId.polygon_zkevm]: {
        [IchiSupportedDex.Pancakeswap]: {
    ...
    [IchiSupportedChainId.taiko_hekla]: {
        [IchiSupportedDex.Henjin]: {
            factoryAddress: '0x7C6389714719C68cAAc8Ae06baE6E878B3605f6D',
            depositGuard: {
    ...
    //     },
    // },
    [IchiSupportedChainId.x_layer_testnet]: {
        [IchiSupportedDex.XSwap]: {
    ...
    //     },
    // },
    [IchiSupportedChainId.zksync_era]: {
        [IchiSupportedDex.Pancakeswap]: {
    ...
    [IchiSupportedChainId.zksync_era_testnet]: {
        [IchiSupportedDex.Velocore]: {
