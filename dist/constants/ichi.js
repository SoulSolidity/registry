...
const ichiAddressConfig = {
    [enums_1.IchiSupportedChainId.arbitrum]: {
        ...
        [enums_1.IchiSupportedDex.Pancakeswap]: {
        ...
        [enums_1.IchiSupportedDex.Ramses]: {
        ...
        [enums_1.IchiSupportedDex.Sushiswap]: {
    ...
    [enums_1.IchiSupportedChainId.arthera]: {
        [enums_1.IchiSupportedDex.Thirdfy]: {
    ...
    [enums_1.IchiSupportedChainId.arthera_testnet]: {
        [enums_1.IchiSupportedDex.Thirdfy]: {
    ...
    [enums_1.IchiSupportedChainId.polygon]: {
        [enums_1.IchiSupportedDex.UniswapV3]: {
            factoryAddress: '0x2d2c72C4dC71AA32D64e5142e336741131A73fc0',
            depositGuard: {
        ...
        [enums_1.IchiSupportedDex.Retro]: {
        ...
        [enums_1.IchiSupportedDex.Quickswap]: {
    ...
    [enums_1.IchiSupportedChainId.mainnet]: {
        [enums_1.IchiSupportedDex.UniswapV3]: {
        ...
        [enums_1.IchiSupportedDex.Blueprint]: {
    ...
    [enums_1.IchiSupportedChainId.base]: {
        [enums_1.IchiSupportedDex.Equalizer]: {
            factoryAddress: '0xfBf38920cCbCFF7268Ad714ae5F9Fad6dF607065',
            depositGuard: {
        ...
        [enums_1.IchiSupportedDex.Equalizer2Thick]: {
        ...
        [enums_1.IchiSupportedDex.Henjin]: {
        ...
        [enums_1.IchiSupportedDex.Trebleswap]: {
    ...
    // [IchiSupportedChainId.berachain]: {
    //     [IchiSupportedDex.Kodiak]: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.berachain_bartio]: {
    //     [IchiSupportedDex.Honeypot]: {
    //         factoryAddress: '0x0aC9e4a0423eec93357e2B0F83ef8c6469FD47F7',
    //         depositGuard: {
    ...
    //     },
    // },
    [enums_1.IchiSupportedChainId.blast]: {
        [enums_1.IchiSupportedDex.Fenix]: {
        ...
        [enums_1.IchiSupportedDex.Thruster]: {
    ...
    [enums_1.IchiSupportedChainId.blast_sepolia_testnet]: {
        [enums_1.IchiSupportedDex.Fenix]: {
    ...
    [enums_1.IchiSupportedChainId.bsc]: {
        [enums_1.IchiSupportedDex.UniswapV3]: {
        ...
        [enums_1.IchiSupportedDex.Thena]: {
        ...
        [enums_1.IchiSupportedDex.ThenaV3Fees]: {
    ...
    [enums_1.IchiSupportedChainId.celo]: {
        [enums_1.IchiSupportedDex.Ubeswap]: {
    ...
    [enums_1.IchiSupportedChainId.eon]: {
        [enums_1.IchiSupportedDex.Ascent]: {
    ...
    [enums_1.IchiSupportedChainId.evmos]: {
        [enums_1.IchiSupportedDex.Forge]: {
    ...
    [enums_1.IchiSupportedChainId.fantom]: {
        [enums_1.IchiSupportedDex.Equalizer]: {
        ...
        [enums_1.IchiSupportedDex.SpiritSwap]: {
    ...
    // [IchiSupportedChainId.flare]: {
    //     [IchiSupportedDex.SparkDex]: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.fuse]: {
    //     [IchiSupportedDex.Voltage]: {
    //         factoryAddress: '0xfBf38920cCbCFF7268Ad714ae5F9Fad6dF607065',
    //         depositGuard: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.haven1_devnet]: {
    //     [IchiSupportedDex.Haven1]: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.hedera]: {
    //     [IchiSupportedDex.SaucerSwap]: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.hedera_testnet]: {
    //     [IchiSupportedDex.SaucerSwap]: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.ink]: {
    //     [IchiSupportedDex.Reservoir]: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.ink_sepolia]: {
    //     [IchiSupportedDex.UniswapV3]: {
    ...
    //     },
    // },
    [enums_1.IchiSupportedChainId.kava]: {
        [enums_1.IchiSupportedDex.Kinetix]: {
            factoryAddress: '0x2d2c72C4dC71AA32D64e5142e336741131A73fc0',
            depositGuard: {
                address: '0xADDA3A15EA71c223a82Af86d4578EF2B076035F1',
                version: 2,
    ...
    [enums_1.IchiSupportedChainId.linea]: {
        [enums_1.IchiSupportedDex.Linehub]: {
        ...
        [enums_1.IchiSupportedDex.Lynex]: {
        ...
        [enums_1.IchiSupportedDex.Metavault]: {
    ...
    // [IchiSupportedChainId.mode]: {
    //     [IchiSupportedDex.Kim]: {
    //         factoryAddress: '0x9FAb4bdD4E05f5C023CCC85D2071b49791D7418F',
    //         depositGuard: {
    ...
    //     },
    // },
    [enums_1.IchiSupportedChainId.mantle]: {
        [enums_1.IchiSupportedDex.Agni]: {
        ...
        [enums_1.IchiSupportedDex.Crust]: {
    ...
    [enums_1.IchiSupportedChainId.polygon_zkevm]: {
        [enums_1.IchiSupportedDex.Pancakeswap]: {
    ...
    // [IchiSupportedChainId.real]: {
    //     [IchiSupportedDex.Pearl]: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.rootstock]: {
    //     [IchiSupportedDex.UniswapV3]: {
    //         factoryAddress: '0x8cCd02E769e6A668a447Bd15e134C31bEccd8182',
    //         depositGuard: {
    ...
    //     },
    // },
    [enums_1.IchiSupportedChainId.scroll]: {
        [enums_1.IchiSupportedDex.UniswapV3]: {
            factoryAddress: '0x9FAb4bdD4E05f5C023CCC85D2071b49791D7418F',
            depositGuard: {
                address: '0xb62399d23d1c81f08eA445A42d7F15cC12090A71',
    ...
    // [IchiSupportedChainId.skale_europa]: {
    //     [IchiSupportedDex.Sushiswap]: {
    ...
    //     },
    // },
    // [IchiSupportedChainId.sonic]: {
    //     [IchiSupportedDex.Equalizer]: {
    ...
    //     },
    // },
    [enums_1.IchiSupportedChainId.taiko]: {
        [enums_1.IchiSupportedDex.Henjin]: {
            factoryAddress: '0x9FAb4bdD4E05f5C023CCC85D2071b49791D7418F',
            depositGuard: {
                address: '0x2E76A8D053f839A04235341dF1f25235437fEDd6',
    ...
    [enums_1.IchiSupportedChainId.taiko_hekla]: {
        [enums_1.IchiSupportedDex.Henjin]: {
            factoryAddress: '0x7C6389714719C68cAAc8Ae06baE6E878B3605f6D',
            depositGuard: {
    ...
    //     },
    // },
    [enums_1.IchiSupportedChainId.x_layer_testnet]: {
        [enums_1.IchiSupportedDex.XSwap]: {
    ...
    // [IchiSupportedChainId.zircuit]: {
    //     [IchiSupportedDex.Ocelex]: {
    ...
    //     },
    // },
    [enums_1.IchiSupportedChainId.zksync_era]: {
        [enums_1.IchiSupportedDex.Pancakeswap]: {
        ...
        [enums_1.IchiSupportedDex.Velocore]: {
    ...
    [enums_1.IchiSupportedChainId.zksync_era_testnet]: {
        [enums_1.IchiSupportedDex.Velocore]: {
...
//     _16[IchiSupportedChainId.rootstock] = '0x8CF119F15575CAb4beb427Fb485087e71a96Fbaa',
//     _16[IchiSupportedChainId.arbitrum] = '0xd9e7c0932a7D3e40Db3Fe78d95A3ED375a37Ab1a',
//     _16[IchiSupportedChainId.berachain] = '0x89ff70257bc747F310bB538eeFC46aDD763e75d8',
//     _16[IchiSupportedChainId.haven1_devnet] = '0xe573920139a208989d83C57ea48837C6285F2cd3',
//     _16[IchiSupportedChainId.fantom] = '0xd9e7c0932a7D3e40Db3Fe78d95A3ED375a37Ab1a',
//     _16[IchiSupportedChainId.hedera_testnet] = '0x0B10E483AAC4340256772754d23131B6E0Dc31EA',
//     _16[IchiSupportedChainId.hedera] = '0x0B10E483AAC4340256772754d23131B6E0Dc31EA',
//     _16[IchiSupportedChainId.ink] = '0xcfEA11557Bc9cB71bc6916e09fC8493D668b8d53',
//     _16[IchiSupportedChainId.ink_sepolia] = '0x27404A54D594Aa6307C3f9Be102646363d6279a1',
//     _16[IchiSupportedChainId.mantle] = '0xf5bb4e61ccAC9080fb520e5F69224eE85a4D588F',
//     _16[IchiSupportedChainId.mode] = '0x481BE66De423B6a0Df368b526713bA632EF23ADd',
//     _16[IchiSupportedChainId.sonic] = '0x9B500c0a544B870D9C4c441147dCaEf599e542E7',
//     _16[IchiSupportedChainId.zircuit] = '0x89EC5589c030FcEf8c29E7EeC491D2E73b53A623',
//     _16[IchiSupportedChainId.zksync_era_testnet] = '0x8A23CB45E5F4d5a1b2DB673663Ea2aAedc48acff',
//     _16[IchiSupportedChainId.zksync_era] = '0x95071cBD09184083E7F732a710c2e30c9882Fd5f',
//     _16[IchiSupportedChainId.polygon_zkevm] = '0xe05b539447B17630Cb087473F6b50E5c5f73FDeb',
//     _16[IchiSupportedChainId.polygon] = '0xFb6021617c03dcEF189C3f783C56e3D9ff284919',
//     _16[IchiSupportedChainId.fuse] = '0x607F5841eFf0505d3c7A868558aD4562fD176C8F',
//     _16[IchiSupportedChainId.bsc] = '0x74d8b6407b8f33b40d7a1e34375176394f59afe6',
//     _16[IchiSupportedChainId.evmos] = '0x8a4A5eEC59899F2d23B08f0188d6eB540cF4EccC',
//     _16[IchiSupportedChainId.arthera] = '0x15fCbF9bC0797567053A8265b7E6f4eC43EA7327',
//     _16[IchiSupportedChainId.arthera_testnet] = '0xEC250E6856e14A494cb1f0abC61d72348c79F418',
//     _16[IchiSupportedChainId.unreal] = '0xe573920139a208989d83C57ea48837C6285F2cd3',
//     _16[IchiSupportedChainId.real] = '0xbBB97d634460DACCA0d41E249510Bb741ef46ad3',
//     _16[IchiSupportedChainId.base] = '0x091e99cb1C49331a94dD62755D168E941AbD0693',
//     _16[IchiSupportedChainId.linea] = '0xe573920139a208989d83C57ea48837C6285F2cd3',
//     _16[IchiSupportedChainId.berachain_bartio] = '0x932E1908461De58b0891E5022431dc995Cb95C5E',
//     _16[IchiSupportedChainId.blast] = '0xdC7f370de7631cE9e2c2e1DCDA6B3B5744Cf4705',
//     _16[IchiSupportedChainId.taiko] = '0xaF0C5CBbCEfB685BF3200684d2aE19B8eA6186ca',
//     _16[IchiSupportedChainId.scroll] = '0xC1D2e074C38FdD5CA965000668420C80316F0915',
//     _16[IchiSupportedChainId.blast_sepolia_testnet] = '0xEc27362204a1D02e9803d0eB4904e8df470b2B39',
//     _16[IchiSupportedChainId.x_layer_testnet] = '0x7B4553a35D3020064cB464a8D75a4735FfdA15Bd',
//     _16[IchiSupportedChainId.celo] = '0x633987602DE5C4F337e3DbF265303A1080324204',
//     _16[IchiSupportedChainId.kava] = '0x481BE66De423B6a0Df368b526713bA632EF23ADd',
//     _16[IchiSupportedChainId.skale_europa] = '0x15bA62A09E6e295A696D02f8E4B80a8a13bF3785',
//     _16);
