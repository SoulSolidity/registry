...
exports.getChainProjects = getChainProjects;
/**
...
exports.projectConfigs = {
    ...
    [types_1.ChainId.BNB]: {
        [types_1.Project.PancakeSwap]: {
            ...
            dexType: types_1.DexType.PANCAKESWAP,
            factories: [
                {
 ...
 */
function getProjectConfig(chainId, projectName) {
    return exports.projectConfigs[chainId]?.[projectName];
}
/**
 ...
 */
function getChainProjects(chainId) {
    return exports.projectConfigs[chainId] || {};
}
